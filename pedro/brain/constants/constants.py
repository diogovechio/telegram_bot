DATE_FULL_FORMAT = "%Y-%m-%d %H:%M:%S.%f%z"
DATE_FORMAT = "%d-%m-%Y"
HOUR_FORMAT = "%H:%M"
...
POLITICAL_WORDS = ["bolsonaro", "lula", "dilma", "temer", "presidente", "thom", "bilion", "tomaz", "política", "politica"]
POLITICAL_OPINIONS = ["Pedro considera que a dilma fez um ótimo governo.",
